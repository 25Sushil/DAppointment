<?php 
    ...
    if(isset($keyword)){
        ...
        $sql = "SELECT ap.id, ap.fullname, ap.phone, ap.bg, ap.address, ap.date, ap.time, sp.title, doc.fname, ap.status from appointment as ap INNER JOIN specialities as sp ON ap.sid = sp.id INNER JOIN doctor as doc ON ap.did = doc.id where ap.did = '$docid'";
    }
    ...
    <section class="dashboard">
        <div class="sidebar">
            ...
            <div class="sidebar-items">
                <ul>
                    <li><a href="../doctor/dash.php" class="click"><svg class="icon icon-dashboard"><use xlink:href="#icon-dashboard"></use></svg>Dashboard</a></li>
                    <li><a href="../doctor/doctor.php" class="click"><svg class="icon icon-medical_services"><use xlink:href="#icon-medical_services"></use></svg>Doctors</a></li>
                    <li><a href="../doctor/patients.php" class="click"><svg class="icon icon-accessible_forward"><use xlink:href="#icon-accessible_forward"></use></svg>Patients</a></li>
                    <li><a href="../doctor/schedule.php" class="click"><svg class="icon icon-access_alarms"><use xlink:href="#icon-access_alarms"></use></svg>Schedule</a></li>
                    <li class="active"><a href="../doctor/appoint.php"><svg class="icon icon-bookmark_outline" class="click"><use xlink:href="#icon-bookmark_outline"></use></svg>Appointment</a></li>
                </ul>
            </div>
        </div>
        <section class="main">
