    ...
    <section class="dashboard">
        <div class="sidebar">
            ...
            <div class="sidebar-items">
                <ul>
                    <li class="active"><a href="../admin/dash.php"><svg class="icon icon-dashboard"><use xlink:href="#icon-dashboard"></use></svg>Dashboard</a></li>
        ...
        <section class="main">
            ...
            <div class="banner hasbg bgfull-fixed" style="background-image: url('../assets/img/doctorgrd.jpg'); color: white;">
                ...
                <div class="button" style="display: flex; justify-content: space-around;">
                    <button class="view"><a href="../admin/doctor.php">View Doctor's</a></button>
                    <button class="view"><a href="../admin/patients.php">View Patient's</a></button>
                    <button class="view"><a href="../admin/schedule.php">View Schedule</a></button>
                    <button class="view"><a href="../admin/appoint.php">View Appointment's</a></button>
                    <button class="view"><a href="../admin/speciality.php">View Specialitie's</a></button>
                </div>
            </div><br>
