<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE `register` SET id=$id, tel='$tel', email='$email', password='$password' where id=$id";
        $result = mysqli_query($conn, $sql);
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-items">
                <ul>
                    ...
                    <li class="active"><a href="../../patient/update.php"><svg class="icon icon-upload"><use xlink:href="#icon-upload"></use></svg>Update</a></li>
                </ul>
            </div>
        </div>
        <div class="main">     
            ...
            <div class="container">
                <form action="#" name="update" method="post">
                    ...
                    <div class="buttons">
                        <button type="submit" name="submit"><a href="update.php?updateid=<?php echo $row['id'] ?>;">Update</a></button>
                    </div>
                </form>
            </div>
