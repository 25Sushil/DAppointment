    ...
    <section class="dashboard">
        <div class="sidebar">
            ...
            <div class="sidebar-items">
                <ul>
                    <li><a href="../admin/dash.php" class="click"><svg class="icon icon-dashboard"><use xlink:href="#icon-dashboard"></use></svg>Dashboard</a></li>
                    <li><a href="../admin/doctor.php" class="click"><svg class="icon icon-medical_services"><use xlink:href="#icon-medical_services"></use></svg>Doctors</a></li>
                    ...
                    <li><a href="../admin/patients.php" class="click"><svg class="icon icon-accessible_forward"><use xlink:href="#icon-accessible_forward"></use></svg>Patients</a></li>
                    <li><a href="../admin/schedule.php" class="click"><svg class="icon icon-access_alarms"><use xlink:href="#icon-access_alarms"></use></svg>Schedule</a></li>
                    ...
                    <li class="active"><a href="../admin/appoint.php"><svg class="icon icon-bookmark_outline" class="click"><use xlink:href="#icon-bookmark_outline"></use></svg>Appointment</a></li>
                </ul>
            </div>
        </div>
        <section class="main">
