...
<body>
    <section class="dashboard">
        <div class="sidebar">
            ...
            <div class="sidebar-items">
                <ul>
                    ...
                    <li  class="active"><a href="../patient/appoint.php"><svg class="icon icon-bookmark_outline"><use xlink:href="#icon-bookmark_outline"></use></svg>Appointment</a></li>
        ...
        <section class="main">
            ...
            <h2>My Appointment's</h2><br>
            <div class="filter-bar">
              <form action="" method="get">
                <div class="date-group">
                    <label>Filter By Date:</label><br>
                    <input type="date" class="date" id="datestring" value="">
                </div>
              </form>
            </div><br>
