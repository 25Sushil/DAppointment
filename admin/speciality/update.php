<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($error == 0){
            ...
            $sql ="UPDATE specialities SET title='$title', description='$description', image_name='$name', image_path='$path' where id=$id;";
            $result = mysqli_query($conn, $sql);
            ...
            <div class="container">
                <form action="" name="update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        ...
                        <textarea id="description" name="description" rows="4" cols="50" value="<?php echo isset($description) ? $description : ''; ?>"></textarea>
