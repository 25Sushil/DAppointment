<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($error == 0){
            ...
            $sql = "INSERT INTO `specialities` (`title`, `description`, `image_name`, `image_path`) VALUES ('$title', '$description', '$name', '$path')";
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-items">
                <ul>
                    ...
                    <li class="active"><a href="../admin/add_speciality.php"><svg class="icon icon-user-plus"><use xlink:href="#icon-user-plus"></use></svg>Add Speciality</a></li>
            ...
            <div class="container">
                <form action="#" name="register" method="post" enctype="multipart/form-data">
                    <div class="input-group">
                        ...
                        <input type="text" id="title" name="title" placeholder="Speciality title" value="<?php echo isset($title) ? $title : ''; ?>">
                    ...
                    <div class="buttons">
                        ...
                        <button type="submit" name="submit" value="register">Add Speciality</button>
                    </div>
                </form>
            </div>
        </div>
